            ...
            for (const [bookName, items] of Object.entries(resultsByBook)) {
              ...
              html += `
                    <div class="book-group ${isFirst ? 'expanded' : ''}">
                        <div class="book-group-header" onclick="this.parentElement.classList.toggle('expanded'); app.playSound('swipe-right');" style="border-left: 4px solid ${themeColor}">
