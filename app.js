    ...
    renderFlashcard() {
       ...
       // 1. Detect which theme the app is currently using
        ...
        for (let i = 0; i < characters.length; i++) {
           ...
           wordHTML += `<span style="color: ${color} !important; font-family: 'TWKai', 'LXGW WenKai TC', serif !important; font-size: clamp(2.15rem, 8.5vw, 3.2rem) !important; margin: 0 2px;">${characters[i]}</span>`;
